...
#admin.site.register((Maincategory,Subcategory,Brand,Product,Buyer,Wishlist,CheckoutProduct,Newslatter,Contact))
...
class ProductAdmin(admin.ModelAdmin):
    list_display=["id","name","maincategory","subcategory","brand","color","size","baseprice","discound","finalprice","stock","pic1","pic2","pic3","pic4"]
